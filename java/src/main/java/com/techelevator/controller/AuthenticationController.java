...
public class AuthenticationController {
   ...
   /* @GetMapping(path = {"/family"})
    public List<User> getFamilyList(){
        ...
        return userDao.getFamilyList();
    }*/

    /*@PostMapping("/addFamilyMember")
    public void addFamilyMember (@RequestBody User newUser) {
        logTimestamp("Adding new user " + newUser.getUsername());
        userDao.addFamilyMember(newUser);
    }*/
